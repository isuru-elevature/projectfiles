...
<body>
    <div class="container">
        <div class="d-flex flex-column mb-3 justify-content-center align-items-center mt-5 w-100">
            <div class="p-2">
                <img src="{{url('public/images/action_step_logo.png')}}" alt="Logo" height="" width="200px">
            </div>
            <div class="p-2">
            ...
            <div class="p-2">
                ...
                <img src="{{url('public/images/logoelevature.png')}}" width="200px"/>
            </div>
            <div class="p-2">
                <p class="heading">File Upload</p>
            </div>
                ...
                <form method="POST" action="{{ route('uploadfile') }}" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('file') is-invalid @enderror"
                            id="exampleInputEmail1" name="file"  required >
                        @error('file')
