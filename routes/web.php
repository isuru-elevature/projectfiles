...
Route::get('/login/actionstep', [LoginController::class, 'redirectToProvider'])->name('login.actionstep');
Route::get('/login/actionstep/callback', [LoginController::class, 'handleProviderCallback'])->name('login.actionstep.callback');
